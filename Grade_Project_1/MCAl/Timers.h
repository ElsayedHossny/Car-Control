...
/******************************************Register_Timer_Direct***************************************************************/

/*timer 0 */
#define  ReadTimer0 TCNT0
#define  WriteTimer0(x) TCNT0=x
#define  Write_OCR0(x) OCR0=x
/*timer 1 */
#define  ReadTimer1 TCNT1
#define  WriteTimer1(x) TCNT1=x
#define  Write_OCR1A(x) OCR1A=x
#define  Write_OCR1B(x) OCR1B=x
...
typedef enum
{
	...
	TIMER1_FastPWM_FF_MODE,
	TIMER1_PhaseCorrect_ICR1_MODE
}Timer1Mode_type;
